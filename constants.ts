...
const PaintBrushIcon: ClassInfo['icon'] = (props) => (
...
// FIX: Replaced JSX with React.createElement to be valid in a .ts file.
const MusicNoteIcon: ClassInfo['icon'] = (props) => (
  React.createElement('svg', { xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 24 24", fill: "currentColor", ...props },
...
// FIX: Replaced JSX with React.createElement to be valid in a .ts file.
const BookOpenIcon: ClassInfo['icon'] = (props) => (
    React.createElement('svg', { xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 24 24", fill: "currentColor", ...props },
...
// FIX: Replaced JSX with React.createElement to be valid in a .ts file.
const BeakerIcon: ClassInfo['icon'] = (props) => (
    React.createElement('svg', { xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 24 24", fill: "currentColor", ...props },
...
export const AGE_RANGE_OPTIONS = ["Pre-K", "K-2", "Ages 3-5", "Ages 6-8", "Ages 9-12"];
